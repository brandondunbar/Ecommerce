...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BannerCreate :  IEquatable<BannerCreate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BannerCreate" /> class.
        /// </summary>
        ...
        /// <param name="isActive">Indicates whether the banner should start as active and be displayed to users..</param>
        public BannerCreate(string title = default(string), string imageUrl = default(string), string linkUrl = default(string), int? displayDuration = default(int?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), PositionEnum? position = default(PositionEnum?), bool? isActive = default(bool?))
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for BannerCreate and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (imageUrl == null)
            {
                throw new InvalidDataException("imageUrl is a required property for BannerCreate and cannot be null");
            }
            else
            {
            ...
            if (linkUrl == null)
            {
                throw new InvalidDataException("linkUrl is a required property for BannerCreate and cannot be null");
            }
            else
            {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for BannerCreate and cannot be null");
            }
            else
            {
            ...
            if (endDate == null)
            {
                throw new InvalidDataException("endDate is a required property for BannerCreate and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Indicates whether the banner should start as active and be displayed to users.
        /// </summary>
        /// <value>Indicates whether the banner should start as active and be displayed to users.</value>
        ...
        {
            return this.Equals(input as BannerCreate);
        }

        /// <summary>
        /// Returns true if BannerCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of BannerCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BannerCreate input)
        {
            if (input == null)
                return false;
