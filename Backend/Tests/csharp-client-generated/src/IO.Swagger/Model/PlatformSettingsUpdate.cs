...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlatformSettingsUpdate :  IEquatable<PlatformSettingsUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformSettingsUpdate" /> class.
        /// </summary>
        ...
        /// <param name="maintenanceMode">Flag to indicate if the site is in maintenance mode. True means the site is in maintenance mode, false means it&#x27;s live..</param>
        ...
        /// <param name="otherSettings">Any other miscellaneous settings that don&#x27;t fit into the above categories..</param>
        public PlatformSettingsUpdate(string siteTitle = default(string), string siteDescription = default(string), bool? maintenanceMode = default(bool?), string defaultCurrency = default(string), List<string> paymentMethods = default(List<string>), PlatformSettingsUpdateShippingConfig shippingConfig = default(PlatformSettingsUpdateShippingConfig), Dictionary<string, Object> otherSettings = default(Dictionary<string, Object>))
        {
            // to ensure "siteTitle" is required (not null)
            if (siteTitle == null)
            {
                throw new InvalidDataException("siteTitle is a required property for PlatformSettingsUpdate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("siteDescription is a required property for PlatformSettingsUpdate and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Flag to indicate if the site is in maintenance mode. True means the site is in maintenance mode, false means it&#x27;s live.
        /// </summary>
        /// <value>Flag to indicate if the site is in maintenance mode. True means the site is in maintenance mode, false means it&#x27;s live.</value>
        ...
        public PlatformSettingsUpdateShippingConfig ShippingConfig { get; set; }

        /// <summary>
        /// Any other miscellaneous settings that don&#x27;t fit into the above categories.
        /// </summary>
        /// <value>Any other miscellaneous settings that don&#x27;t fit into the above categories.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlatformSettingsUpdate {\n");
        ...
        {
            return this.Equals(input as PlatformSettingsUpdate);
        }

        /// <summary>
        /// Returns true if PlatformSettingsUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of PlatformSettingsUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlatformSettingsUpdate input)
        {
            if (input == null)
                return false;
